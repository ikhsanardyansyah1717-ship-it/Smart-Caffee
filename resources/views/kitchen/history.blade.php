...
<section class="panel"><div class="panel-head"><div><h2>Riwayat</h2><p>Daftar pesanan berdasarkan status.</p></div><span class="order-count" id="page-count">0 pesanan</span></div><div id="order-list" class="order-grid"></div></section>
</main></div>
@endsection